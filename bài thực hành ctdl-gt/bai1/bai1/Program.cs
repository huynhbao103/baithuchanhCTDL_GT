    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] ms = { "1. Xem danh sách sinh viên", "2. Thêm sinh viên mới",
                ...
                "6. Cập nhật danh sách vào file","7. sắp xếp theo sinh viên học chuyên ngành","8.điểm trung bình",
                "9. những học sinh học lại:", "0. Thoát" };
            ...
            do
            {
                ...
                switch (chon)
                {
                    ...
                    case 7:
                        ...
                        ds.DsChuyenNghanh(major);
                        break;
                    case 8:
                        float avgScore = ds.DiemAVG();
                        Console.WriteLine($"Diểm trung bình: {avgScore}");
                        break;
                    case 9:
                        ds.DsHoclai();
                        break;
